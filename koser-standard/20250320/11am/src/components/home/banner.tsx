...
export default function Banner({
  ...
  return (
    <section className="_banner-container">
      <Grid>
        <GridItem desktop={5} tablet={6} mobile={5}>
          <div className="_banner-left-content">
            ...
            <GridItem desktop={4} tablet={8} mobile={12}>
        ...
        <GridItem desktop={7} tablet={6} mobile={12}>
          <div className="_banner-right-content">
            <GridItem desktop={12} tablet={12} mobile={12}>
              <div className="_todays-counts">
                ...
                <div className="_content-text">
                  ...
                  >
                    {totalcount}
                    <Typography
                      kind={isMobile ? "title-small" : "title-medium"}
                    >
                      건
                    </Typography>
                  </Typography>
                </div>
                <div className="_todays-counts-bg"></div>
              </div>
            </GridItem>
            <GridItem desktop={12} tablet={12} mobile={12}>
              <div className="_each-counts">
                ...
                <div className="_each-counts-bg"></div>
              </div>
            </GridItem>
          </div>
        </GridItem>
