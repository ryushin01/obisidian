  ...
  return (
    <Grid>
      <GridItem desktop={7} tablet={7} mobile={12}>
        <div className={`relative pt-8 ${isMobile ? "pb-8" : ""}`}>
          <div className="m-2">
            <Typography
              kind={isMobile ? "title-large" : "headline-small"}
              isBold={true}
            >
              실시간 등기현황
            </Typography>
          ...
          <RegistrationStratus />
          <div className={`absolute right-0 ${isMobile ? "top-9" : "top-8"}`}>
            <Button
              shape="none"
              size="sm"
              color="grayscale"
      ...
      <GridItem desktop={5} tablet={5} mobile={12}>
        <div className={`relative pt-8 ${isMobile ? "pb-20" : ""}`}>
          <div className="m-2">
            <Typography
              kind={isMobile ? "title-large" : "headline-small"}
              isBold={true}
