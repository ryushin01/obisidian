...
export default function Table({ isMobile }: ResponsiveType) {
  ...
  // TODO: 등기자료 / 등기접수증 버튼 클릭 시 해당 의뢰번호(rqstNo) 기준으로 데이터 페칭 > 데이터 페칭 완료 시 RegistrationReceiptDetail 컴포넌트로 주입하고 각각 모달 팝업 오픈
        ...
        <Modal title="등기자료" onClose={closeRegistrationDataModal}>
          <Grid>
            ...
            <GridItem desktop={7} tablet={6} mobile={12}>
              <RegistrationDataDetail isMobile={isMobile} />
            </GridItem>
          </Grid>
        </Modal>
      }
      ...
      {isRegistrationReceiptModalOpen &&
        <Modal title="등기접수증" onClose={closeRegistrationReceiptModal}>
          <Grid>
            ...
            <GridItem desktop={7} tablet={6} mobile={12}>
              <RegistrationReceiptDetail isMobile={isMobile} />
            </GridItem>
          </Grid>
        </Modal>
      }
