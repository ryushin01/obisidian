...
// fake GET
export const getFakeData1 = (index: number) => axiosBasicInstance.get(`/todos/${index}`, { baseURL: fakeURI });

export const getFakeData2 = (id: number) => axiosBasicInstance.get(`/albums/${id}/photos`, { baseURL: fakeURI });

export const postFakeData1 = (title, body, userId) => axiosBasicInstance.post(`https://jsonplaceholder.typicode.com/posts`, {
  title,
  body,
  userId,
});
