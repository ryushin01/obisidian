      ...
      <div className="flex flex-col gap-20 p-5">
        ...
        <div className="_responsive-table-inner-wrapper _has-thead">
          <table className="_responsive-table _col-2-type">
            ...
            <tr>
              <th>
                <Typography kind={!!isMobile ? "body-medium" : "title-medium"} isBold={true}>공지사항 내용</Typography>
              </th>
              <th>
                <Typography kind={!!isMobile ? "body-medium" : "title-medium"} isBold={true}>등록일</Typography>
              </th>
            </tr>
            </thead>
            <tbody>
            ...
            <tr className="_emergency">
              <th>
                <span className="_table-content-wrapper">
                  <Image src={AlertTriangleIcon20} alt="긴급점검 아이콘" width={20} height={20} />
                  <Typography kind={!!isMobile ? "body-medium" : "title-medium"}>[긴급점검] 12월 26일 전자등기 시스템</Typography>
                </span>
              </th>
              <td>
                <Typography kind={!!isMobile ? "body-medium" : "title-medium"}>2024-12-25</Typography>
              </td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              <td>
                <Typography kind={!!isMobile ? "body-medium" : "title-medium"}>2410140003</Typography>
              </td>
              <td>
                <Typography kind={!!isMobile ? "body-medium" : "title-medium"}>2024-12-25</Typography>
              </td>
        ...
        <div className="_responsive-table-inner-wrapper _has-thead">
          <table className="_responsive-table _col-7-type">
            ...
            <tr>
              ...
              <td>
                <Typography kind={!!isMobile ? "body-medium" : "title-medium"}>2024-12-17</Typography>
              </td>
              <td>
                <Typography kind={!!isMobile ? "body-medium" : "title-medium"}>배정완료</Typography>
              </td>
              <td>
                <Typography kind={!!isMobile ? "body-medium" : "title-medium"}>오정학</Typography>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <Typography kind={!!isMobile ? "body-medium" : "title-medium"}>미배정</Typography>
              </td>
              <td>
                <Typography kind={!!isMobile ? "body-medium" : "title-medium"}>오정학</Typography>
              </td>
            ...
            <tr>
              ...
              <td>
                <Typography kind={!!isMobile ? "body-medium" : "title-medium"}>접수완료 [55384, 55385]</Typography>
              </td>
              <td>
                <Typography kind={!!isMobile ? "body-medium" : "title-medium"}>오정학</Typography>
              </td>
        ...
        <div className="_responsive-table-inner-wrapper _has-thead">
          <table className="_responsive-table _col-5-type">
            ...
            <tr>
              ...
              <td>
                <Typography kind={!!isMobile ? "body-medium" : "title-medium"}>등기의뢰</Typography>
              </td>
              <td>
                <button type="button">등기자료</button>
              </td>
        ...
        <div className="_responsive-table-inner-wrapper _has-thead">
          <table className="_responsive-table _col-6-type">
            ...
            <tr>
              ...
              <th>
                <Typography kind={!!isMobile ? "body-medium" : "title-medium"} isBold={true}>의뢰자</Typography>
              </th>
              <th>
                <Typography kind={!!isMobile ? "body-medium" : "title-medium"} isBold={true}>의뢰일시</Typography>
              </th>
              <th>
                <Typography kind={!!isMobile ? "body-medium" : "title-medium"} isBold={true}>배정</Typography>
              </th>
            </tr>
            </thead>
            <tbody>
            <tr>
              ...
              <td>
                <Typography kind={!!isMobile ? "body-medium" : "title-medium"}>성북신협</Typography>
              </td>
              <td>
                <Typography kind={!!isMobile ? "body-medium" : "title-medium"}>2024-12-17 15:30:15</Typography>
              </td>
