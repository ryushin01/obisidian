...
// fake GET
export const getFakeData = () => axiosBasicInstance.get("/products/1", { baseURL: fakeURI });

// test GET
export const getTestData = (index: number) => axiosBasicInstance.get(`/test?buttonIndex=${index}`, { baseURL: fakeURI });
